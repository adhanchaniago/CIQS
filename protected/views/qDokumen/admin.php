...
$('.search-form form').submit(function(){
	$('#qdokumen-grid').yiiGridView('update', {
		data: $(this).serialize()
	});
	return false;
});
...
<?php
	$createUrl = $this->createUrl('create',array("asDialog"=>1,"gridId"=>'qdokumen-grid'));
	// IE
	if ($msie) {
	...
	echo CHtml::link(TbHtml::icon(TbHtml::ICON_PLUS_SIGN).' Add new question','#',$onclickCreate);
?>
