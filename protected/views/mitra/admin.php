...
<?php
	$createUrl = $this->createUrl('create',array("asDialog"=>1,"gridId"=>'mitra-grid'));
	// IE
	if ($msie) {
	...
	echo CHtml::link(TbHtml::icon(TbHtml::ICON_PLUS_SIGN).' Add new mitra','#',$onclickCreate);
?>
