...
class InstrukturController extends Controller
{
	...
	{
		$model=new Instruktur;

		// Uncomment the following line if AJAX validation is needed
		// $this->performAjaxValidation($model);

		if (isset($_POST['Instruktur'])) {
			$model->attributes=$_POST['Instruktur'];
	...
	{
		/*$dataProvider=new CActiveDataProvider('Instruktur');
		$this->render('index',array(
			'dataProvider'=>$dataProvider,
		));*/
		$model=new Instruktur('search');
		$model->unsetAttributes();  // clear any default values
		if (isset($_GET['Instruktur'])) {
			$model->attributes=$_GET['Instruktur'];
		}
	 ...
	 * @return Instruktur the loaded model
	 * @throws CHttpException
	 */
	public function loadModel($id)
	{
		$model=Instruktur::model()->findByPk($id);
		if ($model===null) {
	 ...
	 * @param Instruktur $model the model to be validated
	 */
	protected function performAjaxValidation($model)
	{
		if (isset($_POST['ajax']) && $_POST['ajax']==='instruktur-form') {
